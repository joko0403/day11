    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imb1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(BayarActivity.this, BerandaActivity.class);
        ...
        imb2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BayarActivity.this, SejarahActivity.class);
                startActivity(intent);
            }
        });
        ...
        imb4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BayarActivity.this, SayaActivity.class);
                startActivity(intent);
            }
        });
    }
