    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imb1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SejarahActivity.this, BerandaActivity.class);
        ...
        imb3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SejarahActivity.this, BayarActivity.class);
                startActivity(intent);
            }
        });
        ...
        imb4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SejarahActivity.this, SayaActivity.class);
                startActivity(intent);
            }
        });
    }
